...
import 'package:bank_sha/ui/widgets/data_provier_item.dart';
...
class _DataProviderPageState extends State<DataProviderPage> {
  OperatorCardModel? selctedOperatorCard;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  return Column(
                    children: state.operatorCards.map((operatorCard) {
                      return GestureDetector(
                        onTap: () {
                          setState(() {
                            selctedOperatorCard = operatorCard;
                          });
                        },
                        child: DataProviderItem(
                          operatorCard: operatorCard,
                          isSelected:
                              operatorCard.id == selctedOperatorCard?.id,
                        ),
                      );
                    }).toList(),
                  );
      ...
      floatingActionButton: (selctedOperatorCard != null)
          ? Container(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => DataPackagePage(
                        operatorCard: selctedOperatorCard!,
                      ),
                    ),
                  );
                },
